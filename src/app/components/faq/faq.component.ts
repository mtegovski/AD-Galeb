...
export class FaqComponent {
  faqs: FaqItem[] = [
    ...
    },
    {
      ...
      answer: $localize`:@@faqA5:Онлајн преку Обилет, на касата или директно во автобусот доколку има слободно место. Во автобусот може да се купи само еднонасочна карта.`,
      open: false,
    },
    {
      question: $localize`:@@faqQ6:Каде застануваат автобусите?`,
      answer: $localize`:@@faqA6:Сите автобуси застануваат на главните градски станици. Во Скопје има уште две постојки пред главната станица.`,
      open: false,
    },
    {
